const languages = [{
  ...
  id: 'FR-A', label: 'Francés - Avanzado', language: 'Francés', level: 'Avanzado',
}, {
  id: 'AL-A', label: 'Alemán - Avanzado', language: 'Alemán', level: 'Avanzado',
}, {
  id: 'AL-M', label: 'Alemán - Medio', language: 'Alemán', level: 'Medio',
}, {
  id: 'AL-B', label: 'Alemán - Básico', language: 'Alemán', level: 'Básico',
}];
